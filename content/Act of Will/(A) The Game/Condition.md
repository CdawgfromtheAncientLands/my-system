...
| Bodily               | Clumsy X, Feeble X, Strained X, Fatigued X, Sick X                     |
...
- You suffer **–X** to **[[2. Attributes & C|AGI]]**-based **[[1.1 Skill Checks|Skill Check]]s** and **[[1.4 Secondary Attribute|Skill DC]]s**
- You suffer **–X** to **[[1.2 Initiative|Initiative]]** checks
#### <u>Feeble X</u>
*Strength leaks from you.*
- You suffer a -1 penalty to all **[[2. Attributes & C|PHY]]** based [[1.1 Skill Checks|Skill Check]]s and [[1.4 Secondary Attribute|Skill DC]]s for each rank of this condition.
- You suffer **–X** to damage rolls that would add your [[2. Attributes & C|PHY]] modifier. 
#### <u>Strained X</u>
*Intense load has your body aching with every motion.*
- Your **[[1.4 Characteristics|Speed]]s** are reduced by **5ft** per rank of this condition
...
#### <u>Unconscious</u>
*You’re not awake.*
- You cannot [[1.4 Characteristics|Sense]] or do anything.
...
- Suffer **–2** to **[[2. Attributes & C|INS]]-, [[2. Attributes & C|IQ]]-, and [[2. Attributes & C|CHA]]-based** [[1.1 Skill Checks|Skill Check]]s and **[[1.4 Secondary Attribute|Skill DC]]s** per rank of Stupefied.
...
- You can't move more than your base [[1.4 Characteristics|Speed]] in the span of 1 [[1. Types of Actions|Action]]. 
#### <u>Stunned X</u>
