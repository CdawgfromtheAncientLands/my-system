...
---
# Defend (⋄/⟐)
Requirements: You must be holding an item with the [[4.1 Shields|{Block}]] or [[1.2 Weapon Traits|{Parry}]] trait.
...
---
# Take Cover (⋄)
Requirements: You are [[2.1 Reading a Condition|Prone]] or near Cover.
Effect (⋄): You gain the effects of a viable piece of [[3. Cover|Cover]]. If there is no cover nearby, you press into the ground, using whatever terrain you can. Ranged attacks against you that aren’t at point-blank range suffer -1 to hit.
...
Requirements: You must be behind **cover** or within **obscurement** sufficient to break line of sight.
Effect (⋄): Roll **[[Finesse|Sneak]]** versus the **[[Observation|Perception]]** [[1.2 Disciplines & Skills|Skill DC]] of each creature you are trying to hide from.
- **Success.** You become **[[2.4 Detection Rating|Hidden]]** to each creature you beat, or **[[2.4 Detection Rating|Undetected]]** if you were already Hidden to them.
- **Crit Fail.** You become **[[2.4 Detection Rating|Observed]]** by that creature

**Limits:** Re-entering a creature’s line of sight makes you **[[2.4 Detection Rating|Observed]]** by them again. Any action that would naturally reveal your presence either increases your [[2.4 Detection Rating]] or forces another [[Finesse|Sneak]] roll vs. [[Observation|Perception]]. Repeated attempts to hide in the exact same location may impose penalties at the GM’s discretion.

---
# Shield Block (↻)
Trigger: You would take damage from a physical hazard that your shield could block.
Effect: Roll the [[4.1 Shields|Shield]]'s durability once - twice if blocking the effects of a [[1.1 Skill Checks|Crit Fail]] on your part or a [[1.1 Skill Checks|Crit Success]] on a [[Strikes|Strike]] against you.
