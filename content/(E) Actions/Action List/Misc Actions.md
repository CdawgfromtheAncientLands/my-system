...
<font color="#d83931">Requirements:</font> You are equipped with a First Aid Kit and have an [[Open Hand]] to use it - OR you are currently wielding said kit.
<font color="#d83931">Effect:</font> Perform emergency medical treatment. Make a [[Medicine|First Aid]] check, DC 16. Choose **Stabilize** or **Emergency Care** - these count as [[1. Types of Actions|Rider ※]]s on [[Misc Actions|Administer First Aid]].

| Strict Outcome | Stabilize                                                                                                                         | Emergency Care                                                                                                                                                        |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Crit Success   | As Success, but 1 hour and the [[3. Breaking & Dying\|Heal Period]] of the related [[3. Breaking & Dying\|Injury]] is halved.     | As Success, but they automatically succeed the check.                                                                                                                 |
| Success        | Your patient stops [[3. Breaking & Dying\|Dying]] and regains consciousness in 1d4 hours.                                         | If your check beats the DC for a poison affecting the patient, remove the poison. If not, they may make a check against a Poison or Persistent Damage affecting them. |
| Crit Fail      | As success, but 2d4 hours and the [[3. Breaking & Dying\|Heal Period]] of the related [[3. Breaking & Dying\|Injury]] is doubled. | As success, but the patient takes damage from said poison or persistent damage.                                                                                       |
# Toss an Item (⋄/⟐)
[[2. Action & Effect Traits|{Precise}]], [[2. Action & Effect Traits|{R.A.P.}]]
<font color="#d83931">Requirements:</font> You are holding an item you can actually throw.
...
Anything heavier:
- Requires two hands
- Always requires a [[1. Types of Actions|Major ⟐ Action]] toss

<font color="#d83931">Effect (⋄):</font> You throw an object - select a 5x5ft area within 6 [[1.3 Ranged Weapons|Range Increment]]s to throw it at. That is your "target". Roll [[Ranged|Throwing]] as if you were making a [[Ranged]] [[Strikes|Strike]] against said target. The base DC is 14 - affected by [[5. Weather Effects|Wind]] and [[3. Cover|Cover]] as projectiles.
...
<font color="#d83931">Effect (⟐):</font> Ignore penalties from [[3. Cover|Cover]] that would affect the throw, increase range by 5ft, and do not suffer the [[1.1 Skill Checks|Crit Fail]] effects.