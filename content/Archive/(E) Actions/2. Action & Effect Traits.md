...
Actions with the [[2. Action & Effect Traits|{Mental}]] trait can be performed with no physical effort whatsoever. Effects with the {Mental} trait do not affect creatures with 3 or less [[2. Attributes & C|IQ]].
## <font color="#ffc000">{Visual}</font>
Actions with the {Visual} trait only affect targets that can witness them with their [[1.4 Characteristics|Vision]].
