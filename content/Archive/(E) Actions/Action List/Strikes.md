...
---
# Strike (⟐/⋄)
[[2. Action & Effect Traits|{Attack}]], [[2. Action & Effect Traits|{R.A.P.}]]
<font color="#d83931">Effect (⟐):</font> Make a [[Melee]] or [[Shooting]] [[1.1 Skill Checks|Skill Check]] versus a target's [[Core Skills|Reflex]] [[1.4 Secondary Attribute|Skill DC]]. If [[Melee]], this action gains the {Melee} trait. if [[Shooting]], this action gains the {Precise, Concentrate} traits.
- **Crit Success.** As success, but counts as a Harsh [[2.2 Stress|Stressor]] (3d4 Stress) to the target and damage is doubled.
